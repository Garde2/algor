...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        String oldValue = hashMap1.put("+79005554433", "Андрей");
        oldValue = hashMap1.put("+79001234567", "AAAAA");
        ...
        oldValue = hashMap1.put("+70000000000", "Alberto");
        oldValue = hashMap1.put("+71112223344", "Daria");
        oldValue = hashMap1.put("+73334445566", "John");
       ...
       // for (HashMap.Entry<String, String> entry : hashMap1.entrySet()) { 
        ...
        //Iterator<hashMap1<String, String>> iterator1 = hashMap1.entrySet().iterator();
